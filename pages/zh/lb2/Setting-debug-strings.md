...
permalink: /doc/zh/lb2/Setting-debug-strings.html
summary:
---

**See also**: [Operating Node applications](https://docs.strongloop.com/display/SLC/Operating+Node+applications) (`slc`), comes with a built in debugger, Node Inspector that you can use to debug a running application; see [Debugging applications](https://docs.strongloop.com/display/SLC/Debugging+applications) for more information.
...
`$ DEBUG=<_pattern_>[,<_pattern_>...] slc run`
...
<table>
  <tbody>
    ...
    <tr>
      <td>loopback-connector-mssql/example/datagraph.js</td>
      <td>datagraph</td>
    </tr>
    <tr>
