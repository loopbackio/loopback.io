...
permalink: /doc/zh/lb2/Create-new-models.html
summary:
---
...
Recall in [创建一个简单的API](/doc/{{page.lang}}/lb2/6095007.html) step of [Getting started](/doc/{{page.lang}}/lb2/6095006.html) you created a CoffeeShop model.

Now you're going to create two new models, Review and Reviewer, with the `slc loopback` [model generator](/doc/{{page.lang}}/lb2/Model-generator.html).
...
Recall back in part I of [Getting started](/doc/{{page.lang}}/lb2/6095006.html), you [added a boot script](/doc/{{page.lang}}/lb2/6095008.html#id-将API连接至一个数据源-Addsometestdataandviewit) to create a database table from the model (via auto-migration) and add some data to the database.
...
*   `createCoffeeShops()` creates a MySQL table for the CoffeeShop model and adds data to the table.  This is what the `create-sample-models.js` script from [Getting started](/doc/{{page.lang}}/lb2/6095006.html) did.
...
See [Creating a database schema from models](/doc/{{page.lang}}/lb2/Creating-a-database-schema-from-models.html) for more information on auto-migration.
