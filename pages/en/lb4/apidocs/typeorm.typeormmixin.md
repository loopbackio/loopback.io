...
export declare function TypeOrmMixin<T extends MixinTarget<Application>>(superClass: T): {
    new (...args: any[]): {
        ...
        service: <S>(cls: loopbackContext.Constructor<S | loopbackContext.Provider<S>>, nameOrOptions?: string | loopbackContext.ServiceOptions | undefined) => loopbackContext.Binding<S>;
