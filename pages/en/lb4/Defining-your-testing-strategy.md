...
This article continues from [Testing the API](./Testing-the-API.html) and [Defining the API using bottom-up approach](./Defining-the-API-using-bottom-up-approach.html).
" %}
