...
* **docs:** documentation update from initalizing to initializing ([6bd1e2e](https://github.com/loopbackio/loopback-next/commit/6bd1e2ee21ac98e65f83f8bab664c6ad5ccac485))
...
* allow application.stop() to release release resources from init() ([c4487b1](https://github.com/loopbackio/loopback-next/commit/c4487b11713fe2f0084a156bf850dff444cd76f2))
