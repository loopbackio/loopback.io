...
tags:
sidebar: lb3_sidebar
permalink: /doc/en/lb3/Push-notifications-using-Android-SDK.html
summary:
---
...
5.  Edit `src/com/google/android/gcm/demo/app/DemoActivity.java`. 
    * Set SENDER_ID to the project number from the Google Developers Console you created earlier in [Get your Google Cloud Messaging credentials](Push-notifications-for-Android-apps.html).
...
Replace `server-api-key` with the API key you obtained in [Get your Google Cloud Messaging credentials](Push-notifications-for-Android-apps.html).
...
To resolve this, install a compatible version of the Google APIs platform. See [Prepare your Android project](Push-notifications-for-Android-apps.html) for more information.
