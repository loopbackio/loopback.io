...
[`disableMethodByName()`](https://apidocs.strongloop.com/loopback/#model-disableMethodByName) on the model. 
...
```javascript
Location.disableMethodByName('deleteById');
```
...
```javascript
var isStatic = false;
Location.disableMethodByName('updateAttributes');
```

{% include important.html content="Be sure to call `disableMethodByName()` on your own custom model, not one of the built-in models; in the example below, for instance, the calls are `MyUser.disableMethodByName()` _not_ `User.disableMethodByName()`.
" %}
...
```javascript
MyUser.disableMethodByName('create');
MyUser.disableMethodByName('upsert');
MyUser.disableMethodByName('updateAll');
MyUser.disableMethodByName('prototype.updateAttributes');

MyUser.disableMethodByName('find');
MyUser.disableMethodByName('findById');
MyUser.disableMethodByName('findOne');

MyUser.disableMethodByName('deleteById');

MyUser.disableMethodByName('confirm');
MyUser.disableMethodByName('count');
MyUser.disableMethodByName('exists');
MyUser.disableMethodByName('resetPassword');

MyUser.disableMethodByName('prototype.__count__accessTokens');
MyUser.disableMethodByName('prototype.__create__accessTokens');
MyUser.disableMethodByName('prototype.__delete__accessTokens');
MyUser.disableMethodByName('prototype.__destroyById__accessTokens');
MyUser.disableMethodByName('prototype.__findById__accessTokens');
MyUser.disableMethodByName('prototype.__get__accessTokens');
MyUser.disableMethodByName('prototype.__updateById__accessTokens');
```
...
```javascript
Product.disableMethodByName('create');                     // Removes (POST) /products
Product.disableMethodByName('upsert');                     // Removes (PUT) /products
Product.disableMethodByName('deleteById');                 // Removes (DELETE) /products/:id
Product.disableMethodByName('updateAll');                  // Removes (POST) /products/update
Product.disableMethodByName('prototype.updateAttributes'); // Removes (PUT) /products/:id
Product.disableMethodByName('createChangeStream');         // Removes (GET|POST) /products/change-stream
```
...
module.exports = function(Post) {
  Post.disableMethodByName('prototype.__get__tags');
  Post.disableMethodByName('prototype.__create__tags');
  Post.disableMethodByName('prototype.__destroyById__accessTokens'); // DELETE
  Post.disableMethodByName('prototype.__updateById__accessTokens'); // PUT
};
```
