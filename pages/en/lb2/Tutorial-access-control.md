...
This article is reproduced from [loopback-example-access-control](https://github.com/strongloop/loopback-example-access-control)
...
* [Creates 3 users](/server/boot/sample-models.js#L7-L11) (`John`, `Jane`, and `Bob`)
* [Creates project 1, sets `John` as the owner, and adds `John` and `Jane` as `teammembers`](/server/boot/sample-models.js#L14-L29)
* [Creates project 2, sets `Jane` as the owner and solo `teammember`](/server/boot/sample-models.js#L33-L48)
* [Creates a role named `admin` and adds a role mapping to make `Bob` an `admin`](/server/boot/sample-models.js#L50-L65)
...
* Sets the [`POST /projects` route to to render `projects.ejs` when credentials are valid](/server/views/projects.ejs)
  and [renders `index.ejs`](https://github.com/strongloop/loopback-example-access-control/blob/master/server/views/index.ejs) when credentials are invalid
...
In this directory, create [`index.ejs`](https://github.com/strongloop/loopback-example-access-control/blob/master/server/views/index.ejs)
and [`projects.ejs`](https://github.com/strongloop/loopback-example-access-control/blob/master/server/views/projects.ejs).
