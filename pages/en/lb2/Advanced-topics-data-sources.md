...
* settings: An object of properties to configure the connector. Must include a `connector` property, specifying the connector to use.
  See [Connecting models to data sources (Connectors)](/doc/en/lb2/Connecting-models-to-data-sources.html#Connectingmodelstodatasources-Connectors).
...
[Connecting models to data sources (Connectors)](/doc/en/lb2/Connecting-models-to-data-sources.html#Connectingmodelstodatasources-Datasourceproperties).
