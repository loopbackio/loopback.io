...
![todo-tutorial-overview](https://loopback.io/pages/es/lb4/imgs/todo-list-overview.png)

## Setup

If you're following from the tutorial in `@loopback/example-todo`, you can jump
straight to our first step:
[Add TodoList model](http://loopback.io/doc/es/lb4/todo-list-tutorial-model.html)
...
[todo tutorial](http://loopback.io/doc/es/lb4/todo-tutorial.html) if you're not
...
[optional geo-coding step](https://loopback.io/doc/es/lb4/todo-tutorial-geocoding-service.html)
...
[adding a TodoList model](http://loopback.io/doc/es/lb4/todo-list-tutorial-model.html)

### Steps

1.  [Add TodoList Model](http://loopback.io/doc/es/lb4/todo-list-tutorial-model.html)
2.  [Add TodoList Repository](http://loopback.io/doc/es/lb4/todo-list-tutorial-repository.html)
3.  [Add TodoList and TodoList's Todo Controller](http://loopback.io/doc/es/lb4/todo-list-tutorial-controller.html)
