...
- All [CRUD operations](http://loopback.io/doc/ja/lb3/Creating-updating-and-deleting-data.html).
- [Queries](http://loopback.io/doc/ja/lb3/Querying-data.html) with fields, limit, order, skip and where filters.
...
Use the [data source generator](http://loopback.io/doc/ja/lb3/Data-source-generator.html) (`lb datasource`) to add the DASHDB data source to your application.
