...
<div class="gh-only">For more information, see the <a href="http://loopback.io/doc/ja/lb3/PostgreSQL-connector.html">documentation</a>.
<br/><br/>
...
Use the [Data source generator](http://loopback.io/doc/ja/lb3/Data-source-generator.html) to add a PostgreSQL data source to your application.  
