...
###### Notes
- You will need to [configure LoopBack to send email](http://loopback.io/doc/ja/lb3/Email-connector.html) for email related features
...
- `server/views`contains all the views (or pages) rendered by Express using the [EJS templating framework](http://www.ejs.co/)
