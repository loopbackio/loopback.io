...
<div class="gh-only">Please also see <a href="http://loopback.io/doc/ja/lb3/Cassandra-connector.html">LoopBack Cassandra Connector</a> in LoopBack documentation.
</div>
...
Use the [Data source generator](http://loopback.io/doc/ja/lb3/Data-source-generator.html) to add a Cassandra data source to your application.  Select `Cassandra` connector as follows:
```
$ lb datasource
