...
<div class="gh-only">See also <a href="http://loopback.io/doc/ja/lb3/MySQL-connector.html">LoopBack MySQL Connector</a> in LoopBack documentation.
<br/><br/>
...
Use the [Data source generator](http://loopback.io/doc/ja/lb3/Data-source-generator.html) to add a MySQL data source to your application.  
