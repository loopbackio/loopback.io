...
This will install the module from npm and add it as a dependency to the application's [package.json](http://loopback.io/doc/ja/lb3/package.json.html) file.

## Creating a REST data source

Use the [data source generator](http://loopback.io/doc/ja/lb3/Data-source-generator) to add a REST data source to your application.
...
This adds an entry to [datasources.json](http://loopback.io/doc/ja/lb3/datasources.json.html), for example:
