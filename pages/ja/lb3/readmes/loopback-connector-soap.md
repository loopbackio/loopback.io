...
<a href="http://loopback.io/doc/ja/lb3/SOAP-connector.html">LoopBack documentation</a>.
</p>
...
- Use the LoopBack CLI `lb soap` command to automatically create a set of models based on a SOAP service WSDL file.  Often, this will be the easiest way to connect to a SOAP web service, but may not be suitable for all applications.  For more information, see [SOAP generator](http://loopback.io/doc/ja/lb3/SOAP-generator.html).
