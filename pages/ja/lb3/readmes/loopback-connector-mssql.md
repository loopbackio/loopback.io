...
<div class="gh-only">
For more information, see <a href="http://loopback.io/doc/ja/lb3/SQL-Server-connector.html">LoopBack documentation</a>.
</div>
...
Use the [Data source generator](http://loopback.io/doc/ja/lb3/Data-source-generator.html) to add a SQL Server data source to your application.  
